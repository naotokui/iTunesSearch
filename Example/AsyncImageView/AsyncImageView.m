...
- (void)setImage:(UIImage *)image
{
    ...
    if (_crossfadeImages)
    {
        ...
        CATransition *animation = [CATransition animation];
         ((void(*)(id, SEL, id))objc_msgSend)(animation, @selector(setType:), @"kCATransitionFade");
         ((void(*)(id, SEL, float))objc_msgSend)(animation, @selector(setDuration:), _crossfadeDuration);
         ((void (*)(id, SEL, CAAnimation*, NSString*)) objc_msgSend)(self.layer, @selector(addAnimation:forKey:), animation, nil);
    }
    super.image = image;
